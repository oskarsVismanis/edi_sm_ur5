...
// STATE DECLARATION
struct StUr5PostPlace : smacc::SmaccState<StUr5PostPlace, SmUr5>
{
...
//    Transition<EvMoveGroupMotionExecutionCanceled<ClUr5PickAndPlace, OrUr5>, StUr5Initial, CANCELED>,
    Transition<EvMoveGroupMotionExecutionFailed<ClUr5PickAndPlace, OrUr5>, StUr5PostPlace, ABORT> //retry
...
// STATE FUNCTIONS
    ...
    void runtimeConfigure()
    {
      ...
      place_lin_pose.position.z += pickAndPlace->application.cfg.RETREAT_DISTANCE + 0.05;
